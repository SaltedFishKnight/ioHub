package org.king.iohub.server.logic.room;
...
import org.king.iohub.server.logic.room.action.RoomAction;
...
public class RoomLogicServer extends AbstractBrokerClientStartup {
    ...
    public RoomLogicServer(BrokerAddress brokerAddress) {
    ...
    private void addInOutPlugins(BarSkeletonBuilder builder) {
        ...
        ExecutorKit.newSingleScheduled("房间逻辑服-业务线程监控")
